...
urlpatterns = [
    ...
    path('actividad/<int:actividad_id>/editar_participantes/', views.editar_actividad_participantes, name='editar_actividad_participantes'),

    path('actividad/<int:actividad_id>/editar_economica/', views.editar_actividad_economica, name='editar_actividad_economica'),
    path('get-alumnos-unidad/<int:unidad_id>/', views.get_alumnos_unidad, name='get_alumnos_unidad'),

    path('get-alumnos-participantes-unidad/<int:unidad_id>/<int:actividad_id>/', views.get_alumnos_participantes_unidad, name='get_alumnos_participantes_unidad'),
